...
def test_sort_revered_list(reversed_list: list) -> NoReturn:
...
def test_sort_shuffled_list(shuffled_list: list) -> NoReturn:
...
def test_partially_ordered_list(partially_ordered_list: list) -> NoReturn:
